    ...
    try {
        ...
        gLista.salvarEstatisticas("saida.txt");
        cout << "Arquivo 'saida.txt' gerado com estatísticas do grafo.\n";

        // Executa BFS a partir do vértice 1
        gLista.BFS(1, "bfs.txt");
        cout << "Arquivo 'bfs.txt' gerado com árvore de busca BFS.\n";

        // Executa DFS a partir do vértice 1
        gLista.DFS(1, "dfs.txt");
        cout << "Arquivo 'dfs.txt' gerado com árvore de busca DFS.\n";
